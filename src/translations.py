...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
      ...
      **Multiplié par {hours_input:.2f} {hours_unit}{annual_multiplier_text} = {total_kg_co2e:,.2f} kg par an.**
        ...
        "device_percent_check": "(La dernière variable est fixée pour que la somme fasse 100%)",
        ...
        "fixed_network_resolution_percent_check": "(La dernière variable est fixée pour que la somme fasse 100%)",
        "fixed_network_resolution_percent_error": "La somme actuelle des parts est de {percent:.1f}%. Veuillez la réduire à 100%.",
        "mobile_network_resolution_percent_check": "(La dernière variable est fixée pour que la somme fasse 100%)",
        ...
        "co2e_offsetting_train_vs_plane_per_km": "CO2e évité par km en prenant le train au lieu d'avion (kg CO2e / km)",
        "co2e_offsetting_no_meat_meal_vs_beef_meal": "CO2 évité en mangeant un repas végétarien plutôt qu'avec du bœuf (kg CO2e / repas)",
        "co2e_offsetting_tap_water_vs_beer_wine": "CO2 évité en buvant de l'eau du robinet au lieu de bière/vin (kg CO2e / verre)",
        "co2e_offsetting_title": "🌱 Ça ne vous dit rien ? Moi non plus. Alors concrètement, choses que vous devriez faire si vous vouliez compenser ces émissions :",
        ...
        "train_vs_plane_per_km_display": "🚆 Prendre le train au lieu de voler {x} km.",
        "no_meat_meal_vs_beef_meal_display": "🥩 Remplacer {x} repas avec bœuf par un repas végétarien.",
        "tap_water_vs_beer_wine_display": "💧 Boire {x} verres d'eau du robinet au lieu de bière/vin.",
        "emissions_breakdown_title": "📈 Ces émissions se répartissent ainsi :",
...
""",
        ...
        "device_percent_tv": "TV",
        "device_percent_check": "(The last variable is fixed so that the sum equals 100%)",
        ...
        "mobile_network_resolution_percent_2160p": "4K 2160p",
        # Validation messages for resolution percents per network
        "fixed_network_resolution_percent_check": "(The last variable is fixed so that the sum equals 100%)",
        "fixed_network_resolution_percent_error": "The current total share is {percent:.1f}%. Please reduce it to 100%.",
        "mobile_network_resolution_percent_check": "(The last variable is fixed so that the sum equals 100%)",
        ...
        "co2e_offsetting_no_meat_meal_vs_beef_meal": "CO2 avoided by eating a vegetarian meal instead of beef (kg CO2e / meal)",
        "co2e_offsetting_tap_water_vs_beer_wine": "CO2 avoided by drinking tap water instead of beer/wine (kg CO2e / glass)",
        ...
        "train_vs_plane_per_km_display": "🚆 Take the train instead of flying {x} km.",
        "no_meat_meal_vs_beef_meal_display": "🥩 Replace {x} beef meals with vegetarian meals.",
        "tap_water_vs_beer_wine_display": "💧 Drink {x} glasses of tap water instead of beer/wine.",
        "emissions_breakdown_title": "📈 Here’s how these emissions break down:",
