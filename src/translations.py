...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
        ...
        "result_with_production_prefix": "En prenant en compte le CO2e émis pour produire les appareils, cela correspond à :",
        "result_without_production_prefix": "\nSans prendre en compte le CO2e émis pour produire les appareils utilisés pour regarder les vidéos, cela correspond à :",
        "result_explanation": "\nExplication : la majorité du CO2 est émis lors de la fabrication des appareils, mais on ne souhaite pas forcément le prendre en compte lorsque l’on cherche à connaître l’impact carbone (marginal) du visionnage de vidéos. Nous fournissons donc deux valeurs, obtenues en se basant sur des usages types et des paramètres adaptés au réseau français, que vous pouvez modifier dans la barre de gauche. Voir aussi les explications ci-dessous pour mieux comprendre ces paramètres.",
