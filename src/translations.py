...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
      ...
      **Multiplié par {hours_input:.2f} {hours_unit}{annual_multiplier_text} = {total_kg_co2e:,.2f} kg par an.**
        ...
        "co2e_offsetting_title": "🌱 Choses que vous devriez faire si vous vouliez compenser ces émissions...",
...
""",
        ...
        "co2e_offsetting_title": "🌱 Things you should do if you wanted to offset these emissions...",
