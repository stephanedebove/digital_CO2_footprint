...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
      ...
      **Multiplié par {hours_input:.2f} {hours_unit}{annual_multiplier_text} = {total_kg_co2e:,.2f} kg par an.**
        ...
        "alternative_behaviors": "À titre d’exemple, voilà comment vos émissions seraient modifiées si vous renouveliez vos appareils deux fois moins souvent, si vous ne regardiez des vidéos que sur le wifi, et si vous ne les regardiez qu’en résolution 480p (ce qui pour la majorité des contenus est très suffisant pour les petits écrans) :",
        "current_behavior": "Comportement actuel",
        "longer_device_lifetime": "Durée de vie des appareils plus longue",
        "only_wifi": "Uniquement sur Wi-Fi",
        "only_480p": "Uniquement en 480p",
    },
    "en": {
...
""",
        ...
        "alternative_behaviors": "For example, here is how your emissions would change if you renewed your devices twice less often, if you only watched videos on wifi, and if you only watched them in 480p resolution (which for most content is more than sufficient for small screens):",
        "current_behavior": "Current behavior",
        "longer_device_lifetime": "Longer device lifetime",
        "only_wifi": "Only on Wi-Fi",
        "only_480p": "Only in 480p",
    },
}
