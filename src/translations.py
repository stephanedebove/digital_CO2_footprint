...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
      ...
      **Multiplié par {hours_input:.2f} {hours_unit}{annual_multiplier_text} = {total_kg_co2e:,.2f} kg par an.**
        ...
        "co2e_offsetting_tap_water_vs_beer_wine": "CO2 évité en buvant de l'eau du robinet au lieu de bière/vin (kg CO2e / litre)",
        ...
        "tap_water_vs_beer_wine_display": "💧 Boire {x} litres d'eau du robinet au lieu de bière/vin.",
...
""",
        ...
        "co2e_offsetting_tap_water_vs_beer_wine": "CO2 avoided by drinking tap water instead of beer/wine (kg CO2e / liter)",
        ...
        "tap_water_vs_beer_wine_display": "💧 Drink {x} liters of tap water instead of beer/wine.",
