...
_TEXTS: Dict[str, Dict[str, str]] = {
    "fr": {
      ...
      **Multiplié par {hours_input:.2f} {hours_unit}{annual_multiplier_text} = {total_kg_co2e:,.2f} kg par an.**
        ...
        "alternative_behaviors": "À titre d’exemple, voilà comment vos émissions seraient modifiées si vous ne regardiez des vidéos que sur le wifi (en 1080p ou 480p), si vous ne les regardiez que sur le réseau 4G/5G en 480p, ou si vous renouveliez vos appareils deux fois moins souvent :",
        "behavior_axis_title": "Comportement",
        "current_behavior": "Actuel",
        "longer_device_lifetime": "Durée vie x2",
        "only_wifi_only_1080p": "100% Wi-Fi 1080p",
        "only_wifi_only_480p": "100% Wi-Fi 480p",
        "only_mobile_only_480p": "100% 4G/5G 480p",
    },
    "en": {
...
""",
        ...
        "alternative_behaviors": "For example, here is how your emissions would change if you only watched videos on wifi (in 1080p or 480p), if you only watched them on mobile network in 480p, or if you renewed your devices twice less often:",
        "behavior_axis_title": "Behavior",
        "current_behavior": "Current",
        "longer_device_lifetime": "2x device lifetime",
        "only_wifi_only_1080p": "100% Wi-Fi 1080p",
        "only_wifi_only_480p": "100% Wi-Fi 480p",
        "only_mobile_only_480p": "100% mobile network 480p",
    },
}
